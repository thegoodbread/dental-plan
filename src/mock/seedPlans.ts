...
import { TreatmentPlan, TreatmentPlanItem, ShareLink, Patient, FeeUnitType, UrgencyLevel, FeeCategory } from '../types';
...
const itemsA: TreatmentPlanItem[] = [
  ...
  },
  {
    ...
    id: id('item'),
    treatmentPlanId: planA_Id,
    feeScheduleEntryId: 'mock_3',
    procedureCode: 'D3330',
    procedureName: 'Endodontic therapy, molar',
    category: 'RESTORATIVE', // Simplified category
    unitType: 'PER_TOOTH',
    selectedTeeth: [19],
    baseFee: 1100,
    grossFee: 1100,
