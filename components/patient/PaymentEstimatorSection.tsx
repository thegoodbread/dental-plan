      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gray-50 rounded-3xl border border-gray-200 p-6 md:p-8 mb-8">
           ...
           <div className="h-4 w-full bg-gray-200 rounded-full overflow-hidden flex mb-3">
              <div className="h-full bg-green-500" style={{ width: `${(insuranceEstimate/totalFee)*100}%` }} title="Insurance"></div>
              <div className="h-full bg-blue-500 flex-1" title="You"></div>
           </div>
           ...
           <div className="bg-white rounded-2xl p-5 md:p-6 border border-gray-200">
               ...
               <div className="bg-blue-50 rounded-xl p-6 text-center">
                  ...
                  <div className="text-sm text-gray-500">
                    for {term} months = ${patientPortion.toLocaleString('en-US', { minimumFractionDigits: 0 })} total
                  </div>
               </div>
           </div>
